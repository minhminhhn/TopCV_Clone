! function(e, n) {
    ...
    function n(e, n, t, r, o, i) {
        void 0 !== e && this.setFunctionName(e), void 0 !== n && this.setArgs(n), void 0 !== t && this.setFileName(t), void 0 !== r && this.setLineNumber(r), void 0 !== o && this.setColumnNumber(o), void 0 !== i && this.setSource(i)
    }
    return n.prototype = {
...
var SourceMap = function(e) {
    ...
    function o(e) {
        ...
        var t = s.getArg(n, "version"),
            r = s.getArg(n, "sources"),
            o = s.getArg(n, "names", []),
        ...
        }), this._names = c.fromArray(o, !0), this._sources = c.fromArray(r, !0), this.sourceRoot = i, this.sourcesContent = a, this._mappings = u, this.file = l
    }
    ...
    r.fromSourceMap = function(e) {
        ...
        if (null != this.sourceRoot && (t.source = s.relative(this.sourceRoot, t.source)), !this._sources.has(t.source)) return [];
        t.source = this._sources.indexOf(t.source);
        var r = [],
            o = this._findMapping(t, this._originalMappings, "originalLine", "originalColumn", s.compareByOriginalPositions, u.LEAST_UPPER_BOUND);
        if (o >= 0) {
            ...
            if (void 0 === e.column)
                ...
                for (var c = i.originalColumn; i && i.originalLine === n && i.originalColumn == c;) r.push({
                    line: s.getArg(i, "generatedLine", null),
                    column: s.getArg(i, "generatedColumn", null),
                    lastColumn: s.getArg(i, "lastGeneratedColumn", null)
                }), i = this._originalMappings[++o]
        ...
        var n = Object.create(o.prototype),
            t = n._names = c.fromArray(e._names.toArray(), !0),
            r = n._sources = c.fromArray(e._sources.toArray(), !0);
        ...
        for (var a = e._mappings.toArray().slice(), u = n.__generatedMappings = [], l = n.__originalMappings = [], p = 0, g = a.length; g > p; p++) {
            var h = a[p],
                m = new i;
            m.generatedLine = h.generatedLine, m.generatedColumn = h.generatedColumn, h.source && (m.source = r.indexOf(h.source), m.originalLine = h.originalLine, m.originalColumn = h.originalColumn, h.name && (m.name = t.indexOf(h.name)), l.push(m)), u.push(m)
        }
        ...
        for (var t, r, o, a, u, c = 1, p = 0, g = 0, h = 0, m = 0, d = 0, v = e.length, _ = 0, y = {}, w = {}, b = [], O = []; v > _;)
            if (";" === e.charAt(_)) c++, _++, p = 0;
            else if ("," === e.charAt(_)) _++;
        else {
            for (t = new i, t.generatedLine = c, a = _; v > a && !this._charIsMappingSeparator(e, a); a++);
            if (r = e.slice(_, a), o = y[r]) _ += r.length;
            else {
            ...
            t.generatedColumn = p + o[0], p = t.generatedColumn, o.length > 1 && (t.source = m + o[1], m += o[1], t.originalLine = g + o[2], g = t.originalLine, t.originalLine += 1, t.originalColumn = h + o[3], h = t.originalColumn, o.length > 4 && (t.name = d + o[4], d += o[4])), O.push(t), "number" == typeof t.originalLine && b.push(t)
        }
        f(O, s.compareByGeneratedPositionsDeflated), this.__generatedMappings = O, f(b, s.compareByOriginalPositions), this.__originalMappings = b
        ...
        var n = {
            ...
            t = this._findMapping(n, this._generatedMappings, "generatedLine", "generatedColumn", s.compareByGeneratedPositionsDeflated, s.getArg(e, "bias", r.GREATEST_LOWER_BOUND));
        if (t >= 0) {
        ...
        var t;
        if (null != this.sourceRoot && (t = s.urlParse(this.sourceRoot))) {
        ...
        var t = {
            ...
            o = this._findMapping(t, this._originalMappings, "originalLine", "originalColumn", s.compareByOriginalPositions, s.getArg(e, "bias", r.GREATEST_LOWER_BOUND));
        if (o >= 0) {
            var i = this._originalMappings[o];
    ...
    }, n.BasicSourceMapConsumer = o, a.prototype = Object.create(r.prototype), a.prototype.constructor = r, a.prototype._version = 3, Object.defineProperty(a.prototype, "sources", {
        get: function() {
        ...
        var n = {
            ...
            t = u.search(n, this._sections, function(e, n) {
        ...
        for (var n = 0; n < this._sections.length; n++) {
            ...
            if (-1 !== t.consumer.sources.indexOf(s.getArg(e, "source"))) {
        ...
        for (var t = 0; t < this._sections.length; t++)
            for (var r = this._sections[t], o = r.consumer._generatedMappings, i = 0; i < o.length; i++) {
                var a = o[i],
    ...
    function i(e) {
        ...
        for (var a, s = n.isAbsolute(t), u = t.split(/\/+/), c = 0, l = u.length - 1; l >= 0; l--) a = u[l], "." === a ? u.splice(l, 1) : ".." === a ? c++ : c > 0 && ("" === a ? (u.splice(l + 1, c), c = 0) : (u.splice(l, 2), c--));
        return t = u.join("/"), "" === t && (t = s ? "/" : "."), i ? (i.path = t, o(i)) : t
    }
    ...
    function l(e, n, t) {
        ...
        return 0 !== r ? r : (r = e.originalLine - n.originalLine, 0 !== r ? r : (r = e.originalColumn - n.originalColumn, 0 !== r || t ? r : (r = e.generatedColumn - n.generatedColumn, 0 !== r ? r : (r = e.generatedLine - n.generatedLine, 0 !== r ? r : e.name - n.name))))
    }

    function f(e, n, t) {
        var r = e.generatedLine - n.generatedLine;
        return 0 !== r ? r : (r = e.generatedColumn - n.generatedColumn, 0 !== r || t ? r : (r = e.source - n.source, 0 !== r ? r : (r = e.originalLine - n.originalLine, 0 !== r ? r : (r = e.originalColumn - n.originalColumn, 0 !== r ? r : e.name - n.name))))
    }
    ...
    function g(e, n) {
        ...
        return 0 !== t ? t : (t = e.generatedColumn - n.generatedColumn, 0 !== t ? t : (t = p(e.source, n.source), 0 !== t ? t : (t = e.originalLine - n.originalLine, 0 !== t ? t : (t = e.originalColumn - n.originalColumn, 0 !== t ? t : p(e.name, n.name)))))
    }
    n.getArg = t;
    var h = /^(?:([\w+\-.]+):)?\/\/(?:(\w+:\w+)@)?([\w.]*)(?::(\d+))?(\S*)$/,
        m = /^data:.+\,.+$/;
    n.urlParse = r, n.urlGenerate = o, n.normalize = i, n.join = a, n.isAbsolute = function(e) {
        return "/" === e.charAt(0) || !!e.match(h)
    }, n.relative = s, n.toSetString = u, n.fromSetString = c, n.compareByOriginalPositions = l, n.compareByGeneratedPositionsDeflated = f, n.compareByGeneratedPositionsInflated = g
}, function(e, n) {
    function t(e, r, o, i, a, s) {
        var u = Math.floor((r - e) / 2) + e,
            c = a(o, i[u], !0);
        return 0 === c ? u : c > 0 ? r - u > 1 ? t(u, r, o, i, a, s) : s == n.LEAST_UPPER_BOUND ? r < i.length ? r : -1 : u : u - e > 1 ? t(e, u, o, i, a, s) : s == n.LEAST_UPPER_BOUND ? u : 0 > e ? -1 : e
    }
    ...
    r.fromArray = function(e, n) {
        for (var t = new r, o = 0, i = e.length; i > o; o++) t.add(e[o], n);
        return t
    }, r.prototype.size = function() {
        return Object.getOwnPropertyNames(this._set).length
    }, r.prototype.add = function(e, n) {
        var t = o.toSetString(e),
            r = this._set.hasOwnProperty(t),
            i = this._array.length;
        (!r || n) && this._array.push(e), r || (this._set[t] = i)
    ...
    n.encode = function(e) {
        var n, t = "",
            o = r(e);
        do n = o & u, o >>>= a, o > 0 && (n |= c), t += i.encode(n); while (o > 0);
        return t
    ...
    n.encode = function(e) {
        ...
        var n = 65,
            ...
            c = 26,
            l = 52;
        return e >= n && t >= e ? e - n : e >= r && o >= e ? e - r + c : e >= i && a >= e ? e - i + l : e == s ? 62 : e == u ? 63 : -1
    }
}, function(e, n) {
    function t(e, n, t) {
        var r = e[n];
    ...
    function o(e, n, i, a) {
        if (a > i) {
            var s = r(i, a),
                u = i - 1;
            t(e, s, a);
            for (var c = e[a], l = i; a > l; l++) n(e[l], c) <= 0 && (u += 1, t(e, u, l));
            t(e, u + 1, l);
            var f = u + 1;
...
! function(e, n) {
    ...
    function t(e) {
        return new Promise(function(n, t) {
            ...
            r.open("get", e), r.onerror = t, r.onreadystatechange = function() {
                4 === r.readyState && (r.status >= 200 && r.status < 300 ? n(r.responseText) : t(new Error("HTTP status: " + r.status + " retrieving " + e)))
            }, r.send()
        })
    }
    ...
    function i(e, n) {
        for (var t, r = /function\s+([^(]*?)\s*\(([^)]*)\)/, o = /['"]?([$_A-Za-z][$_A-Za-z0-9]*)['"]?\s*[:=]\s*function\b/, i = /['"]?([$_A-Za-z][$_A-Za-z0-9]*)['"]?\s*[:=]\s*(?:eval|new Function)\b/, a = e.split("\n"), s = "", u = Math.min(n, 20), c = 0; u > c; ++c) {
            var l = a[n - c - 1],
                f = l.indexOf("//");
            if (f >= 0 && (l = l.substr(0, f)), l) {
                if (s = l + s, t = o.exec(s), t && t[1]) return t[1];
                if (t = r.exec(s), t && t[1]) return t[1];
                if (t = i.exec(s), t && t[1]) return t[1]
            }
        }
    }
    ...
    function c(t, r, o, i, a) {
        var s = new e.SourceMapConsumer(t),
            u = s.originalPositionFor({
                line: o,
                column: i
            }),
            c = s.sourceContentFor(u.source);
        return c && (a[u.source] = c), new n(u.name, r, u.source, u.line, u.column)
    }
    return function l(e) {
        return this instanceof l ? (e = e || {}, this.sourceCache = e.sourceCache || {}, this.ajax = e.ajax || t, this._atob = e.atob || r, this._get = function(n) {
            return new Promise(function(t, r) {
                var o = "data:" === n.substr(0, 5);
                if (this.sourceCache[n]) t(this.sourceCache[n]);
            ...
            return new Promise(function(t, r) {
                s(e), this._get(e.fileName).then(function(r) {
                    var o = i(r, e.lineNumber, e.columnNumber);
                    t(new n(o, e.args, e.fileName, e.lineNumber, e.columnNumber))
                }, r)["catch"](r)
            }.bind(this))
            ...
            return new Promise(function(n, t) {
                ...
                this._get(i).then(function(a) {
                    ...
                    "/" === s[0] || l || /^https?:\/\/|^\/\//i.test(s) || (s = f + s), this._get(s).then(function(t) {
                        var i = e.lineNumber,
                            a = e.columnNumber;
                        "string" == typeof t && (t = o(t.replace(/^\)\]\}'/, ""))), "undefined" == typeof t.sourceRoot && (t.sourceRoot = f), n(c(t, e.args, i, a, r))
                    }, t)["catch"](t)
                }.bind(this), t)["catch"](t)
            }.bind(this))
        })) : new l(e)
...
function(e, n) {
    ...
    return {
        backtrace: function(n) {
            var t = [],
                r = 10;
            "object" == typeof n && "number" == typeof n.maxStackSize && (r = n.maxStackSize);
            for (var o = arguments.callee; o && t.length < r;) {
                for (var i = new Array(o.arguments.length), a = 0; a < i.length; ++a) i[a] = o.arguments[a];
                /function(?:\s+([\w$]+))+\s*\(/.test(o.toString()) ? t.push(new e(RegExp.$1 || void 0, i)) : t.push(new e(void 0, i));
                try {
                    o = o.caller
                } catch (s) {
                    break
...
function(e, n) {
    ...
    function n(e, n, t) {
        ...
        for (var r = new Array(e.length), o = 0; o < e.length; o++) r[o] = n.call(t, e[o]);
        return r
    }

    function t(e, n, t) {
        if ("function" == typeof Array.prototype.filter) return e.filter(n, t);
        for (var r = [], o = 0; o < e.length; o++) n.call(t, e[o]) && r.push(e[o]);
        return r
    }
    var r = /(^|@)\S+\:\d+/,
        o = /^\s*at .*(\S+\:\d+|\(native\))/m,
    ...
    return {
        ...
        extractLocation: function(e) {
            ...
            return [n.join(":"), t, void 0]
        },
        parseV8OrIE: function(r) {
            var i = t(r.stack.split("\n"), function(e) {
                return !!e.match(o)
            }, this);
            return n(i, function(n) {
                n.indexOf("(eval ") > -1 && (n = n.replace(/eval code/g, "eval").replace(/(\(eval at [^\()]*)|(\)\,.*$)/g, ""));
                var t = n.replace(/^\s+/, "").replace(/\(eval code/g, "(").split(/\s+/).slice(1),
                    r = this.extractLocation(t.pop()),
                    o = t.join(" ") || void 0,
                    i = ["eval", "<anonymous>"].indexOf(r[0]) > -1 ? void 0 : r[0];
                return new e(o, void 0, i, r[1], r[2], n)
            }, this)
        },
        parseFFOrSafari: function(r) {
            var o = t(r.stack.split("\n"), function(e) {
                return !e.match(i)
            }, this);
            return n(o, function(n) {
                if (n.indexOf(" > eval") > -1 && (n = n.replace(/ line (\d+)(?: > eval line \d+)* > eval\:\d+\:\d+/g, ":$1")), -1 === n.indexOf("@") && -1 === n.indexOf(":")) return new e(n);
                var t = n.split("@"),
                    r = this.extractLocation(t.pop()),
                    o = t.join("@") || void 0;
                return new e(o, void 0, r[0], r[1], r[2], n)
            }, this)
        },
    ...
    return {
        ...
        fromError: function(n, o) {
            ...
            return new Promise(function(t) {
                var r = e.parse(n);
                "function" == typeof o.filter && (r = r.filter(o.filter)), t(Promise.all(r.map(function(e) {
                    return new Promise(function(n) {
                        function t() {
                            n(e)
                        }
                        a.pinpoint(e).then(n, t)["catch"](t)
                    })
                })))
            }.bind(this))
        },
        ...
        instrument: function(e, n, t, r) {
            ...
            var i = function() {
                try {
                    ...
                    throw o(i) && this.fromError(i).then(n, t)["catch"](t), i
                }
            }.bind(this);
        ...
        report: function(e, n) {
            return new Promise(function(t, r) {
                ...
                o.onerror = r, o.onreadystatechange = function() {
                    4 === o.readyState && (o.status >= 200 && o.status < 400 ? t(o.responseText) : r(new Error("POST to " + n + " failed with status: " + o.status)))
                }, o.open("post", n), o.setRequestHeader("Content-Type", "application/json"), o.send(JSON.stringify({
                    stack: e
                }))
            })
        }
